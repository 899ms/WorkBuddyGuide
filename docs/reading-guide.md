...
3. 完成第一个可检查的任务。
4. 加载一个真正用得上的 Skill。
5. 学习连接器，通过[第 8 章飞书办公实战](/bluebook/第一篇%20使用手册：先把%20WorkBuddy%20用起来/第%208%20章%20飞书办公实战：从接入到交付/)跑通一项办公任务。
6. 继续学习 IM 助理、外部 API 与自动化任务。
...
- 处理 Word、Excel、PPT：第 12 章。
- 整理电脑文件：第 13 章。
- 远程控制电脑：第 14 章。
- 资讯、收藏、会议和投资：第 16～19 章。
- AI 视频、自媒体和 GEO：第 20～22 章。
