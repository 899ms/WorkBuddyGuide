  ...
  "/bluebook/": [
    { text: "蓝皮书总览", link: "/bluebook/" },
    {
      ...
      items: [
        ...
        child(part1, "第 8 章 飞书办公实战：从接入到交付"),
        child(part1, "第 8 章 WorkBuddy 接入小程序与 IM 助理", "第 9 章 WorkBuddy 接入小程序与 IM 助理"),
        child(part1, "第 9 章 如何接入外部 API", "第 10 章 如何接入外部 API"),
        child(part1, "第 10 章 WorkBuddy 自动化任务", "第 11 章 WorkBuddy 自动化任务"),
    ...
    },
    {
      ...
      items: [
        item(part2, "本篇导读"),
        child(part2, "第 11 章 办公三件套：Word、Excel、PPT", "第 12 章 办公三件套：Word、Excel、PPT"),
        child(part2, "第 12 章 从整理桌面文件这些小事做起", "第 13 章 从整理桌面文件这些小事做起"),
        child(part2, "第 13 章 远程控制你的电脑，不用发愁不在电脑前", "第 14 章 远程控制你的电脑，不用发愁不在电脑前"),
        child(part2, "第 14 章 生活助手的价值，是减少琐碎", "第 15 章 生活助手的价值，是减少琐碎"),
        child(part2, "第 15 章 资讯整合：把信息流变成每日通知", "第 16 章 资讯整合：把信息流变成每日通知"),
        child(part2, "第 16 章 收藏不是知识管理，能再次用起来才是", "第 17 章 收藏不是知识管理，能再次用起来才是"),
        child(part2, "第 17 章 会议结束不是终点，工作才刚刚开始", "第 18 章 会议结束不是终点，工作才刚刚开始"),
        child(part2, "第 18 章 把投资分析变成你的日常", "第 19 章 把投资分析变成你的日常"),
        child(part2, "第 19 章 一句话召唤 AI 视频团队", "第 20 章 一句话召唤 AI 视频团队"),
        child(part2, "第 20 章 自媒体不只是靠努力，而是一条增长闭环", "第 21 章 自媒体不只是靠努力，而是一条增长闭环"),
        child(part2, "第 21 章 WorkBuddy也能做GEO专家", "第 22 章 WorkBuddy也能做GEO专家"),
      ],
    },
    {
      text: "第三篇 · 进阶系统",
      ...
      items: [
        item(part3, "本篇导读"),
        child(part3, "第 22 章 打造skill：将书和视频蒸馏为可执行 Skill", "第 23 章 打造skill：将书和视频蒸馏为可执行 Skill"),
        child(part3, "第 23 章 其他用法补充：WorkBuddy 实操案例集", "第 24 章 其他用法补充：WorkBuddy 实操案例集"),
        child(part3, "第 24 章 如何进行多 Agent 系统设计", "第 25 章 如何进行多 Agent 系统设计"),
        child(part3, "第 25 章 自动化工作流的可靠性", "第 26 章 自动化工作流的可靠性"),
      ],
    },
    {
      text: "第四篇 · 岗位与行业",
      ...
      items: [
        item(part4, "本篇导读"),
        child(part4, "第 26 章 岗位路线图：不同岗位如何把 WorkBuddy 用深", "第 27 章 岗位路线图：不同岗位如何把 WorkBuddy 用深"),
        child(part4, "第 27 章 行业路线图：从通用能力到行业工作流", "第 28 章 行业路线图：从通用能力到行业工作流"),
      ],
    },
    {
      text: "附录",
